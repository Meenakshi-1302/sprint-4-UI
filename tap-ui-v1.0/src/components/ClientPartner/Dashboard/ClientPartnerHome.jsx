...
function ClientPartnerHome() {
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className={`p-6 flex flex-col transition-margin duration-300 ${isSidebarOpen ? 'ml-64' : 'ml-16'}`}> {/* Adjust margin based on sidebar state */}
                <div className="min-h-screen bg-gray-50">
                    <ClientNavbar setSidebarOpen={setIsSidebarOpen} sidebarOpen={isSidebarOpen} />
...
export default ClientPartnerHome
