...
import { sendOtp } from '../../services/ThirdPartyCredentials/ThirdPartyCredentialsForgetService';
...
const ForgotPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const trimmedEmail = email.trim(); // Use the local state variable email
    ...
    try {
      const response = await sendOtp(trimmedEmail); // Send the email from the state instead
